---
title: "Getting Started with Managed Providers"
description: "Deploy custom MCP server code without managing infrastructure."
---

<Note>
**What you'll learn:**
- How to create a managed provider
- Supported languages
</Note>
...
Metorial supports two languages for managed providers:
...
## Creating a Managed Provider

<Steps>
  <Step title="Navigate to Custom Providers">
    Go to **Gateway** → **Managed Providers**.

    ![Navigate to managed providers](/images/custom-servers/navigate-managed-servers.png)
  </Step>
  <Step title="Create Provider">
    Click **Create Managed Provider** and select **Managed Provider**.

    ![Create managed provider](/images/custom-servers/create-managed-server.png)
  </Step>
