...
<Note>
  **What you'll learn:**
  ...
  - What changes after you start the Workforce trial
...
Open **Workforce** from the top navigation. If the product is not active yet, the page shows a **Free 7 Day Trial** callout with feature cards for:
...
After you start the trial, the page switches to the active Workforce dashboard with the trial banner, connection activity, Portals card, and Accounts table.

![Active Workforce trial](/images/dashboard-audit/workforce-active-trial.png)
...
| --- | --- | --- |
| Workforce | `/workforce` | Trial status, activity, portals, and account overview |
...
Magic Skills appear inside Workforce once the trial is active. They are reusable skills that can enable workflows across agents and teams.
...
<Tip>
  Workforce can be started from the dashboard with a 7-day trial. After activation, the project shows the remaining trial days and unlocks the Workforce sidebar.
</Tip>
