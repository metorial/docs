---
title: "Workforce"
description: "Workforce is the control plane for giving employees, agents, and external users governed access to tools, integrations, portals, and skills."
---
...
- Which employees, agents, or external users can use approved tools?
...
| Accounts | Manage employees or external users that receive access |
...
Workforce also includes lower-level identity and delegation pages. Use them when you need durable ownership for employees, agents, external users, or delegated access relationships.
