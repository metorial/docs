---
title: "Workforce"
description: "Workforce is the control plane for giving employees and agents governed access to tools, integrations, portals, and skills."
---

Workforce is where admins turn approved tool access into something employees and agents can actually use. It brings together portals, integrations, skills, Magic MCP, accounts, agents, and activity so access is governed from one place instead of scattered across credentials and one-off setup.

<Note>
  **What you'll learn:**

  - What Workforce manages for admins, employees, and agents
