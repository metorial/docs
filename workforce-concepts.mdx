...
description: "Understand how Workforce gives AI apps, AI clients, and agents governed access through portals, integrations, skills, MCP URLs, and activity logs."
---

Workforce is the control plane for AI access. Admins choose which integrations and skills are approved, employees connect the apps they use for work, AI clients and agents connect through managed MCP URLs, and activity logs trace usage, tool calls, and access events.
...
AI apps, clients, and agents need access to the systems where work happens, but unmanaged access quickly becomes difficult to approve, explain, and audit. Workforce gives teams one place to decide which integrations are allowed, who can use them, how employees connect them, and how usage is monitored.
