...
## Step 1: Deploy GitHub Provider

Deploy the GitHub provider from Metorial's catalog to enable your bot to interact with GitHub.
...
<Steps>
  ...
  <Step title="Deploy GitHub Provider">
    Click the **GitHub** provider, then click **Deploy** → **Provider Deployment**.
