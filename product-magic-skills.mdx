...
Skills can start from a portal user or from an admin in the dashboard. Use the portal path when the person closest to the work wants to capture a workflow. Use the dashboard path when an admin wants to publish approved skills, templates, or groups to a portal.

<Steps>
  <Step title="Create a personal skill">
    A portal user can create a personal skill when they know the workflow best. A support lead can draft a refund handling skill, a sales teammate can write an account research skill, and an operations teammate can turn a recurring checklist into something agents can follow.

    ![Collaborative skill editor](/images/dashboard-audit/skill-collaborative-editor.png)
  </Step>

  <Step title="Collaborate before sharing">
  ...
  <Step title="Publish approved skills from the dashboard">
    For admin-managed skills, the dashboard controls what appears in the portal and who can use it. Add a skill resource to the portal, choose the skill, template, or group, and allow the right access groups.

    ![Portal skill listings](/images/dashboard-audit/portal-admin-skills.png)
  </Step>

  <Step title="Use skills from the portal">
