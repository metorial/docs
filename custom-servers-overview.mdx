...
Clone and modify an existing integration from the catalog. Start with a working integration and customize it to your needs. The forked provider becomes a custom provider that you can deploy and update.
