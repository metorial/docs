...
## Step 1: Deploy Google Calendar Provider

First, deploy the Google Calendar provider from the Metorial catalog:

<Steps>
  <Step title="Navigate to Provider Catalog">
    Go to [app.metorial.com](https://app.metorial.com) and click **Providers**
  </Step>
  ...
  <Step title="Deploy">
    Click **Deploy** and note your deployment ID (starts with `pdp_`)
  </Step>
</Steps>
...
## Step 1b: Deploy Gmail Provider

Next, deploy the Gmail provider for email communications:
...
<CardGroup cols={2}>
  ...
  <Card title="Provider Catalog" icon="server" href="/integrations-browsing-catalog">
    Explore more providers to add capabilities
  </Card>
</CardGroup>
