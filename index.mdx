...
Start with the employees and agents who need approved access to company tools. Workforce gives admins the control plane, portals give employees a place to discover integrations and Magic Skills, and activity logs show usage, tool calls, and access events.

<CardGroup cols={2}>
  <Card title="Understand Workforce" icon="users" href="/metorial-101-introduction">
    Open Workforce and map the employees, agents, portals, integrations, and Magic Skills you want to manage.
  </Card>
