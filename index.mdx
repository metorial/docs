...
description: "Metorial gives teams one place to manage tool access for employees, agents, and external users. Use it to publish approved integrations, share reusable skills, connect MCP clients safely, and see what happened after work runs."
---

## Start With Workforce

Start with the employees and agents who need approved access to company tools. Workforce gives admins the control plane, portals give employees a place to discover integrations and Magic Skills, and activity shows what happened after work runs.
