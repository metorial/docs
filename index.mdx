---
title: "Metorial"
description: "Metorial gives teams one place to manage how AI apps, AI clients, and agents access work apps and internal systems. Use it to publish approved integrations, share reusable skills, connect MCP clients safely, and monitor access, usage, and tool activity."
---

## Start With Workforce

Metorial helps teams replace scattered AI tool access, one-off MCP setup, and hard-to-audit credentials with a governed Workforce. Admins decide which apps, systems, and skills are approved, employees discover them through portals, AI clients connect through managed MCP access, and activity logs show how access is used.
