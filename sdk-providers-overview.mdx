...
**For Python projects**, pass `provider="anthropic"` or `provider="openai"` when creating a session. The Python SDK formats tools automatically for the provider you specify, and you use the official Python SDK from each provider to make model calls.
