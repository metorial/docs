...
See the [Server Deployment API](/api/server-deployment) documentation for endpoint details, authentication, and request/response schemas.
...
<CardGroup cols={2}>
  <Card title="Server Deployment API" icon="code" href="/api/server-deployment">
    API reference for creating deployments.
  </Card>
