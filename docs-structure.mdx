...
flowchart TD
  ...
  B --> B3["Set Up Workforce"]
  B --> B4["Launch A Portal"]
  B --> B5["Test Portal Access"]
...
| Activity | Operational logs for sessions, connections, tool calls, provider runs, errors, alerts, and auth events | [Review Activity](/metorial-101-monitoring) |
...
flowchart TD
  ...
  B --> B1["What is Metorial Workforce?"]
