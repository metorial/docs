---
title: "Providers"
description: "Providers are catalog or custom integrations you connect to Metorial. Understanding integrations, Magic MCP servers, configs, auth configs, and provider deployments lets you control exactly how each provider is configured and authenticated."
---
...
![GitHub Magic MCP auth config](/images/dashboard-audit/provider-github-create-magic-mcp-flow.png)
